...
export type Configuration<TSpec extends SpecType = SpecType> = GeneralConfiguration & OpenConfiguration & CheckConfiguration & ClassicConfiguration<TSpec> & VGConfiguration;
export declare class ConfigurationData<TSpec extends SpecType = SpecType> implements Required<Configuration<TSpec>> {
