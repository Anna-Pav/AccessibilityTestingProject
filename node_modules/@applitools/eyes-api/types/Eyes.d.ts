...
import { SpecType, CoreSpec, CoreTargetImage } from './Core';
...
export declare class Eyes<TSpec extends SpecType = SpecType> {
    ...
    extractText(target: CoreTargetImage, settings: OCRRegion<TSpec>[]): Promise<string[]>;
    /** @deprecated */
